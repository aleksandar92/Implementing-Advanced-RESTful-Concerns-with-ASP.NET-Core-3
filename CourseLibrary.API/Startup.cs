...
namespace CourseLibrary.API
{
    public class Startup
    {
        ...
        {
            services.AddHttpCacheHeaders( (expitationModelOption) => {
                expitationModelOption.MaxAge = 60;
                expitationModelOption.CacheLocation = Marvin.Cache.Headers.CacheLocation.Private;
            },
